...
{
    public partial class relationTasta : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrainNotes_PrimaryNote = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GrainNotes_SecondaryNote = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GrainNotes_TerciaryNote = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PronouncedNote = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GrainChar_Variety = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GrainChar_Altitude = table.Column<int>(type: "int", nullable: true),
                    GrainChar_Origin = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GrainChar_Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Process = table.Column<int>(type: "int", nullable: false),
                    RoasterProfile = table.Column<int>(type: "int", nullable: false),
                    Roaster = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Grains", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Shippiment = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    LoteNumber = table.Column<int>(type: "int", nullable: false),
                    RoasteDate = table.Column<DateTime>(type: "datetime", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buys_Grains_GrainId",
                        column: x => x.GrainId,
                        principalTable: "Grains",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buys_GrainId",
                table: "Buys",
                column: "GrainId");

            migrationBuilder.CreateIndex(
                name: "IX_Grains_TasteId",
                table: "Grains",
                column: "TasteId");
        }
